    ...
    _createClass(TransferList, [{
        ...
        value: function render() {
            ...
            var showItems = dataSource.map(function (item) {
                ...
                return React.createElement(Item, { key: item.key, item: item, lazy: lazy, renderedText: renderedText, renderedEl: renderedEl, checked: checked, prefixCls: prefixCls, onClick: _this4.handleSelect });
            });
