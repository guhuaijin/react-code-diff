...
var _initialiseProps = function _initialiseProps() {
    ...
    if (!windowIsUndefined) {
      _this3.levelDom.forEach(function (dom) {
        if (_this3.isOpenChange || openTransition) {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_9__utils__["a" /* addEventListener */])(dom, __WEBPACK_IMPORTED_MODULE_9__utils__["f" /* transitionEnd */], _this3.trnasitionEnd);
          var levelValue = open ? value : 0;
          if (levelMove) {
            var $levelMove = Object(__WEBPACK_IMPORTED_MODULE_9__utils__["e" /* transformArguments */])(levelMove, { target: dom, open: open });
    ...
    return __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(
        'div',
        {
          ...
          style: {
            transform: transform,
            width: Object(__WEBPACK_IMPORTED_MODULE_9__utils__["c" /* isNumeric */])(width) ? width + 'px' : width,
            height: Object(__WEBPACK_IMPORTED_MODULE_9__utils__["c" /* isNumeric */])(height) ? height + 'px' : height
          }
        },
        __WEBPACK_IMPORTED_MODULE_3_react___default.a.createElement(
          'div',
  ...
  this.removeMoveHandler = function (e) {
    ...
    if (currentTarget === _this3.maskDom || currentTarget === _this3.handlerdom || currentTarget === _this3.contentDom && ((currentTarget.scrollTop + currentTarget.offsetHeight >= currentTarget.scrollHeight && differY < 0 || currentTarget.scrollTop <= 0 && differY > 0) && Math.max(Math.abs(differX), Math.abs(differY)) === differY || (currentTarget.scrollLeft + currentTarget.offsetWidth >= currentTarget.scrollWidth && differX < 0 || currentTarget.scrollLeft <= 0 && differX > 0) && Math.max(Math.abs(differX), Math.abs(differY)) === differX)) {
      e.preventDefault();
    }
  };

  this.trnasitionEnd = function (e) {
    Object(__WEBPACK_IMPORTED_MODULE_9__utils__["d" /* removeEventListener */])(e.target, __WEBPACK_IMPORTED_MODULE_9__utils__["f" /* transitionEnd */], _this3.trnasitionEnd);
...
Drawer.propTypes = {
  ...
  width: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.any,
  height: __WEBPACK_IMPORTED_MODULE_5_prop_types___default.a.any,
